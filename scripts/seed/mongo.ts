/*
  Simple local seed using MongoDB and Accounts.js.
  Creates a demo user and verifies the email.
  Assumes Docker mongo from root docker-compose is running on localhost:27017.
*/
...
async function main() {
  ...
  await accountsPassword.requestVerificationEmail(DEMO_EMAIL);
